...
export default connect((state) => state)(function Farming({ metamask }) {
  const [farm, onFarm] = useState(null)
      ...
      {farm ? (
        ...
        <Wrapper className="center">
          ...
          <p className="intro">
            ...
            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud laboris nisi ut aliquip ex ea commodo consequat.
          ...
          <RewardTokens className="flex-wrap justify-center">
            <div className="reward-token cursor flex-all relative" onClick={() => onFarm('$hrimp')}>
